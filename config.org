...
* Terminal & Runners
** TODO vterm vs. eat?
** TODO Scratchpad-like Terminal
- [[https://github.com/jixiuf/vterm-toggle][vterm-toggle]] might be a good option
- Check if ~eat~ has something similar

** TODO Run npm/go/... scripts
Find out the idiomatic emacs way of doing this.
