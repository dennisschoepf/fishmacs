...
** Indentation Guides
[[https://github.com/jdtsmith/indent-bars?tab=readme-ov-file#configuring-tree-sitter][indent-bars.el]] is a package that optionally utilizes Treesitter for its indentation guides. These links include more information on how to configure specific indentation guides per language with Treesitter ([[https://github.com/jdtsmith/indent-bars?tab=readme-ov-file#tree-sitter-details][Treesitter Details]], [[https://github.com/jdtsmith/indent-bars?tab=readme-ov-file#tree-sitter][Treesitter]]).
...
** TODO LSP Setup
Here is a tutorial: [[https://arne.me/blog/emacs-config-from-scratch-part-three][Arne.me / LSP and Treesitter setup]]. There is ~lsp-booster~ and ~lsp-bridge~ if performance is lacking. ~lsp-mode~ together with ~lsp-booster~ might be the easiest to setup.
