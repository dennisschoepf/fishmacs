...
** Fonts
Defining the fonts I am using. Currently only ~Iosevka Term~.
...
** TODO Improve shell ergonomics (see Doom Emacs) 
** TODO Use ~multi-vterm~ for multiplexing
** TODO Use emacs daemon for session storing
* TODO Projects
Will probably be using projectile
...
** TODO Org Agenda Filters
** TODO Org Calendar Integration
- [ ] Decide on if I want to go down this path, if so use [[https://github.com/dengste/org-caldav/blob/master/doc/org-caldav.org][org-caldav]]

** TODO Denote/Org Roam
* TODO Writing Setup (& Homepage)
* TODO Programming Setup
* Misc
** Diminish
