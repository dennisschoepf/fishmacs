...
#+Description: My emacs config based on kickstartmacs
...
** TODO Session and Perspective Management
...
** TODO Visual Undo
I have to decide if I want to go for ~vundo~ or ~undo-tree~. Might need to watch some videos on how it could/should work in Emacs in general.
