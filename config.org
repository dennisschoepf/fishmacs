...
** TODO Visual Undo
I have to decide if I want to go for ~vundo~ or ~undo-tree~.
...
And finally [[https://github.com/awth13/org-appear][org-appear]] to see the hidden emphasis markers when hovering over them.
