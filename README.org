...
[[https://github.com/LionyxML/emacs-kick/blob/9fae955ebf471a191b34c3d3e2836532067bfe1b/init.el#L654][This]] could help. Initially setup LSP for ~TS~, ~Astro~, ~Go~, ~Typst~, ~Tailwind~, ~CSS~, ~JSON~, ~YAML~, ~Docker(-compose)~.
