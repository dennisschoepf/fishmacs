...
** Helpers
Some helper functions to e.g. call externally via ~emacsclient --eval~.
...
* Treesitter
As of September 2025 Treesitter is still not really plug-and-play in Emacs. Therefore I am using ~treesit-auto~ to simplify installing and setting up the ~-ts~ modes.
